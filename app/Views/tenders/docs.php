...
<div class="container p-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= base_url('/tenders/docs_create') ?>" class="btn btn-primary">
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('tenders/docs_edit/' . $type['id']) ?>" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="<?= base_url('/docs_delete/' . $type['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">
